...
"""Host-owned receipt layout for required Cost audit and lineage acceptance."""
...
RECEIPTS = ResourceRef("evidence", "cost_test", "receipts")


class CostReceiptProvider:
    provider_id = "cost.test-receipts"
    provider_contract_version = "1.0.0"

    def documents(self):
        return (
            SchemaDocument(
                ref=SchemaReference(CatalogName.EVIDENCE, "cost_test", "receipts", "1.0.0"),
    ...
    def load(self):
        ...
        return ResourceBundle(
            ...
            namespaces=(NamespaceDefinition("evidence", "cost_test"),),
            schemas=(schema,),
            resources=(
                ResourceDefinition(
                    RECEIPTS,
